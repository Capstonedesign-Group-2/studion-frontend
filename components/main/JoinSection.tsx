  ...
  return (
    <section className='relative px-4 sm:px-6 lg:px-8'>
      <article className='mx-auto max-w-screen-xl'>
        <h1 className='text-5xl tracking-tight leading-tight font-semibold text-gray-800 sm:text-5xl md:text-6xl relative text-center pt-40' style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.1)' }}>
          Online Band.<br />
          Play your moment.
        </h1>
