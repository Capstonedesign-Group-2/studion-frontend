    ...
    if (degreeRef.current >= 0 && degreeRef.current <= 360) {
      ...
      switch (label) {
        case "PAN":
          ...
          break;
        case "Delay":
          channel.setDelay(parseInt(degreeRatio.toString()) / 260 + 0.5);
      }
    }
  };
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="relative flex justify-center items-center h-12 aspect-square rounded-full bg-gray-700">
        ...
        <button ref={knobRef}>
          <div
            className="flex justify-center h-10 aspect-square rounded-full bg-gray-800 shadow-studion-400 shadow"
