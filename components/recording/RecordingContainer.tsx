...
const RecordingContainer: React.FC<Props> = ({ audioFile, setAudioFile, audioFiles, setAudioFiles, isLoading  }) => {
  ...
  return (
    <>
      ...
      <div className="px-5 xl:px-16 pb-8 pt-8">
        <Controller mixerRef={mixerRef} audioFile={audioFile} setAudioFile={setAudioFile} audioFiles={audioFiles} setAudioFiles={setAudioFiles} isLoading={isLoading} setIsPlaying={setIsPlaying} />
      </div>
    </>
  )
}
